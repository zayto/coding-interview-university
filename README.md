...
- ### Linked Lists
    ...
    - [ ] Implement (did that with tail pointer):
        ...
        - [x] traverseInReverse() - prints the values of each element in list in reverse order
        - [x] traverse() - prints the values of each element in list in order
    - [ ] Doubly-linked List
